...
#   4. 独立窗口启动硬件（HUD 实时刷新）
#   5. 独立窗口启动示教节点（teach_one_node）
#   6. Ctrl+C 退出时自动清理所有窗口和进程
# ==================================================
...
# ---------- 5. 示教节点（独立窗口） ----------
echo -e "\033[34m[5/5] 启动示教节点...\033[0m"
gnome-terminal --title="${TITLE_PREFIX}control" -- \
  bash -c "source $WS/devel/setup.bash; rosrun arm_control teach_one_node; exec bash" &
