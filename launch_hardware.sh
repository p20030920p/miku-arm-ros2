...
# ---------- 1. ROS 2 环境（已在 arm_common.sh 里 source 完成） ----------
echo -e "\033[34m[1/3] ROS 2 环境就绪（Jazzy，无需 roscore）\033[0m"

# ---------- 2. 显示：robot_state_publisher + RViz2（独立窗口） ----------
echo -e "\033[34m[2/3] 启动显示...\033[0m"
arm_start_display

# ---------- 3. 硬件（独立窗口，HUD） ----------
echo -e "\033[34m[3/3] 启动硬件...\033[0m"
arm_start_hardware
